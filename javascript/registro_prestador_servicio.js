document.getElementById('registro_prestador_servicioForm').addEventListener('submit', function (event) {
  ...
  fetch("https://backend-homerservice-production.up.railway.app/prestador_servicio/registrar", requestOptions)
    .then((response) => {
      if (response.status == 400) {
        ...
        Swal.fire({
          ...
          if (res.isConfirmed) {
            ...
            window.location.href = "/frontend-homeService/vistas/login.html"
          }
